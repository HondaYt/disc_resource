                  ...
                  Expanded(
                    child: Padding(
                      ...
                      child: AppinioSwiper(
                        ...
                        cardCount: _recentlyPlayed.length,
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                      'Current Playback Time: ${_currentPlaybackTime.inMinutes}:${(_currentPlaybackTime.inSeconds % 60).toString().padLeft(2, '0')}'),
                                  Slider(
                                    value: _currentPlaybackTime.inSeconds
                                        .toDouble(),
                        ...
                        onSwipeEnd: (int previousIndex, int targetIndex,
                          ...
                          if (targetIndex >= 0 &&
                              targetIndex < _recentlyPlayed.length) {
                            playSong(_recentlyPlayed[targetIndex]);
                          }
                        },
                        onEnd: () {
